								...
								var y = (function e(t) {
									...
									var l,
										...
										G = m(
											...
											function (e, n) {
												return (
													e ||
													(RegExp('\\b' + (n.pattern || S(n)) + '\\b', 'i').exec(t) &&
														(n.label || n))
												);
											}
										),
									...
									if (
										...
										/\bAndroid\b/.test(K) &&
											...
											(X = x(l[1]).replace(/^[a-z]{2}-[a-z]{2};\s*/i, '') || null),
										D && !X
											? (X = L([D]))
											: D &&
											  X &&
											  (X = X.replace(RegExp('^(' + S(D) + ')[-_.\\s]', 'i'), D + ' ').replace(
													RegExp('^(' + S(D) + ')[-_.]?(\\w)', 'i'),
													D + ' $2'
											  )),
										...
										'IE' == N && /\blike iPhone OS\b/.test(t)
											? ((D = (l = e(t.replace(/like iPhone OS/, ''))).manufacturer),
											  (X = l.product))
											: /^iP/.test(X)
											? (N || (N = 'Safari'),
											  (K =
													'iOS' +
													((l = / OS ([\d_]+)/i.exec(t)) ? ' ' + l[1].replace(/_/g, '.') : '')))
											: 'Konqueror' == N && /^Linux\b/i.test(K)
											? (K = 'Kubuntu')
											: (D &&
													'Google' != D &&
													((/Chrome/.test(N) && !/\bMobile Safari\b/i.test(t)) ||
														/\bVita\b/.test(X))) ||
											  (/\bAndroid\b/.test(K) && /^Chrome/.test(N) && /\bVersion\//i.test(t))
											? ((N = 'Android Browser'), (K = /\bAndroid\b/.test(K) ? K : 'Android'))
											: 'Silk' == N
											? (/\bMobi/i.test(t) || ((K = 'Android'), $.unshift('desktop mode')),
											  /Accelerated *= *true/i.test(t) && $.unshift('accelerated'))
											: 'UC Browser' == N && /\bUCWEB\b/.test(t)
											? $.push('speed mode')
											: 'PaleMoon' == N && (l = /\bFirefox\/([\d.]+)\b/.exec(t))
											? $.push('identifying as Firefox ' + l[1])
											: 'Firefox' == N && (l = /\b(Mobile|Tablet|TV)\b/i.exec(t))
											? (K || (K = 'Firefox OS'), X || (X = l[1]))
											: !N || (l = !/\bMinefield\b/i.test(t) && /\b(?:Firefox|Safari)\b/.exec(N))
											? (N &&
													!X &&
													/[\/,]|^[^(]+?\)/.test(t.slice(t.indexOf(l + '/') + 8)) &&
													(N = null),
											  (l = X || D || K) &&
													(X || D || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(K)) &&
													(N = /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(K) ? K : l) + ' Browser'))
											: 'Electron' == N &&
										...
										(l =
											('iCab' == G && parseFloat(j) > 3
												? 'WebKit'
												: /\bOpera\b/.test(N) && (/\bOPR\b/.test(t) ? 'Blink' : 'Presto')) ||
											(/\b(?:Midori|Nook|Safari)\b/i.test(t) &&
												!/^(?:Trident|EdgeHTML)$/.test(G) &&
												'WebKit') ||
											(!G && /\bMSIE\b/i.test(t) && ('Mac OS' == K ? 'Tasman' : 'Trident')) ||
											('WebKit' == G && /\bPlayStation\b(?! Vita\b)/i.test(N) && 'NetFront')) &&
											(G = [l]),
										'IE' == N && (l = (/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(t) || 0)[1])
											? ((N += ' Mobile'),
										...
										if (
											...
											g((l = n.runtime)) == w
												? ((N = 'Adobe AIR'), (K = l.flash.system.Capabilities.os))
												: g((l = n.phantom)) == M
												? ((N = 'PhantomJS'),
												  (j = (l = l.version || null) && l.major + '.' + l.minor + '.' + l.patch))
												: 'number' == typeof k.documentMode && (l = /\bTrident\/(\d+)/i.exec(t))
												? ((j = [j, k.documentMode]),
												  (l = +l[1] + 4) != j[1] &&
														($.push('IE ' + j[1] + ' mode'), G && (G[1] = ''), (j[1] = l)),
												...
												('object' == typeof l.versions &&
													('string' == typeof l.versions.electron
														...
														: 'string' == typeof l.versions.nw &&
														  ($.push('Chromium ' + j, 'Node ' + l.versions.node),
														  (N = 'NW.js'),
														  (j = l.versions.nw))),
												N ||
													((N = 'Node.js'),
									...
									if (
										(j &&
											(l =
												...
												/(?:alpha|beta)(?: ?\d)?/i.exec(t + ';' + (F && o.appMinorVersion)) ||
										...
										(!/^(?:Chrome|IE|Opera)$/.test(N) && (!N || X || /Browser|Mobi/.test(N))) ||
										...
										if ('IE' == N && F)
											...
											(l =
												(RegExp(X.replace(/ +/g, ' *') + '/([.\\d]+)', 'i').exec(t) || 0)[1] || j)
												? ((K =
														((l = [l, /BB10/.test(t)])[1]
															? ((X = null), (D = 'BlackBerry'))
															: 'Device Software') +
												...
												: this != h &&
												  'Wii' != X &&
												  ((F && R) ||
														(/Opera/.test(N) && /\b(?:MSIE|Firefox)\b/i.test(t)) ||
														('Firefox' == N && /\bOS X (?:\d+\.){2,}/.test(K)) ||
														('IE' == N &&
															((K && !/^Win/.test(K) && j > 5.5) ||
									...
									(l = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(t) || 0)[1]) &&
										...
										'Safari' == N && '+' == l[1].slice(-1)
											? ((N = 'WebKit Nightly'), (T = 'alpha'), (j = l[1].slice(0, -1)))
											: (j != l[1] && j != (l[2] = (/\bSafari\/([\d.]+\+?)/i.exec(t) || 0)[1])) ||
											  (j = null),
										...
										'Safari' == N && (!j || parseInt(j) > 45)
											? (j = l)
											: 'Chrome' == N && /\bHeadlessChrome/i.test(t) && $.unshift('headless')),
										'Opera' == N && (l = /\bzbov|zvav$/.exec(K))
											? ((N += ' '),
											  $.unshift('desktop mode'),
											  'zvav' == l ? ((N += 'Mini'), (j = null)) : (N += 'Mobile'),
											  (K = K.replace(RegExp(' *' + l + '$'), '')))
											: 'Safari' == N && /\bChrome\b/.exec(G && G[1])
											? ($.unshift('desktop mode'),
											  (N = 'Chrome Mobile'),
											  (j = null),
											  /\bOS X\b/.test(K) ? ((D = 'Apple'), (K = 'iOS 4.3+')) : (K = null))
										...
										G &&
											...
											(/Browser|Lunascape|Maxthon/.test(N) ||
												('Safari' != N && /^iOS/.test(K) && /\bSafari\b/.test(G[1])) ||
										...
										(l = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(W)) && !/\bi686\b/i.test(W)
											? (K &&
													((K.architecture = 64),
									...
									return (
										...
										K &&
											N &&
											(K != String(K).split(' ')[0] || (K != N.split(' ')[0] && !X)) &&
											$.push(X ? '(' + K + ')' : 'on ' + K),
				...
				function (e, t, n) {
					...
					var S = function (e, t) {
						...
						if (
							...
							return console.warn('Ackee ignores you because you are on localhost'), a;
						if (!0 === ((r = navigator.userAgent), /bot|crawler|spider|crawling/i.test(r)))
							return console.warn('Ackee ignores you because you are a bot'), a;
						return {
							record: function (e) {
								var n =
										arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : b(t.detailed),
							...
							updateRecord: function (e) {
								...
								if (!0 === u(e))
									return (
										console.warn('Ackee ignores you because this is your own site'), { stop: r }
									);
